...
// Mock data for India & Nepal destinations
const destinations = [
  {
    id: 1,
    name: "Kathmandu",
  ...
  return (
    <section className="py-12 md:py-16 bg-white w-full font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Carousel Container - 'group/slider' is used here */}
        <div className="relative group/slider">
          ...
          >
            {destinations.map((dest) => (
              // Destination Card - Uses standard 'group' for card-specific hover effects
              <div 
                key={dest.id}
